...
const Signin = () => {
    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center bg-stone-50 dark:bg-stone-950 overflow-hidden font-body">
            ...
            {/* ░░ ambient glow ░░ */}
            <div className="absolute left-1/2 top-1/3 h-[500px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-400/[0.07] dark:bg-blue-500/[0.15] blur-[120px]" />
            <div className="absolute -bottom-20 -right-20 h-[350px] w-[350px] rounded-full bg-indigo-300/[0.08] dark:bg-indigo-600/[0.08] blur-[100px]" />
            <div className="absolute -top-10 -left-10 h-[250px] w-[250px] rounded-full bg-blue-200/[0.06] dark:bg-blue-700/[0.06] blur-[80px]" />
            ...
            <div className="pointer-events-none absolute inset-0 z-0">
                ...
                <div className="absolute left-0 top-1/3 h-px w-full bg-gradient-to-r from-transparent via-stone-300/30 dark:via-stone-700/20 to-transparent" />
                <div className="absolute left-0 bottom-1/3 h-px w-full bg-gradient-to-r from-transparent via-stone-300/30 dark:via-stone-700/20 to-transparent" />
            </div>
            ...
            >
                ...
                <motion.div variants={fadeUp} transition={{ duration: 0.5 }}>
                    <Link
                        to="/"
                        className="group my-5 inline-flex items-center gap-2 text-sm text-stone-500 dark:text-stone-400 transition-colors hover:text-stone-900 dark:hover:text-white"
                    >
                ...
                >
                    ...
                    <motion.div variants={fadeUp} transition={{ duration: 0.5 }} className="text-center mb-8">
                        ...
                        <h1 className="text-2xl font-bold text-stone-900 dark:text-white">Sign in to your account</h1>
                        <p className="mt-2 text-sm text-stone-500 dark:text-stone-400">Pick up right where you left off</p>
                    </motion.div>
                    ...
                    {/* Form */}
                    <motion.form variants={fadeUp} transition={{ duration: 0.5 }} onSubmit={handleSignIn} className="space-y-4">
                        <div>
