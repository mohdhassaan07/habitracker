...
const LeftSidebar = () => {
    ...
    return (
        <>
            ...
            <div className="border border-white/20 dark:border-gray-700/30 bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl z-10 rounded-2xl absolute lg:relative top-11 lg:top-0 left-1 lg:left-0 min-w-56 w-56 m-2 lg:min-h-[97.5vh] min-h-[70vh] lg:max-h-screen">
                ...
                <div className="p-3 relative">
                    ...
                    <button onClick={() => setisAiOpen(!isAiOpen)} className="absolute hidden mt-2 w-[12.5rem] top-[24rem] lg:top-[32rem] lg:inline-flex items-center justify-center px-3 lg:px-5 py-2 text-sm lg:text-base font-semibold text-white bg-linear-to-r
